import { X, AlertTriangle, Package, FolderOpen, Tag } from 'lucide-react';
      ...
      >
        <div className="p-6 border-b border-red-200 dark:border-red-900/30 bg-red-50 dark:bg-red-900/10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-red-700 dark:text-red-400">Reset Data</h3>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6">
          <p className="text-sm text-[var(--text-secondary)] mb-4 leading-relaxed">
            Anda akan menghapus <strong>semua data</strong> berikut ini secara permanen:
          </p>
          ...
          <div className="p-4 bg-amber-50 dark:bg-amber-900/20 border-2 border-amber-300 dark:border-amber-800/50 rounded-xl mb-6">
              ...
              <div>
                ...
                <ul className="text-xs text-amber-800 dark:text-amber-300 space-y-1 leading-relaxed">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Aksi ini <strong>tidak dapat dibatalkan</strong></span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5">•</span>
                    <span>Akun dan profil Anda tetap aman</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5">•</span>
