          ...
          <div className="sticky top-20">
            <div className="bg-[var(--surface-1)] border border-[var(--border)] rounded-2xl shadow px-6 py-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-[var(--text-primary)]">Kebijakan Privasi</h2>
                  <p className="text-sm text-[var(--text-secondary)]">Bagaimana kami mengumpulkan, menggunakan, dan melindungi data Anda.</p>
                </div>
              </div>
        ...
        <article className="lg:col-span-8">
          <div className="bg-[var(--surface-1)] border border-[var(--border)] rounded-2xl shadow divide-y divide-[var(--divider)] overflow-hidden">
            <header className="p-8">
              <h1 className="text-4xl lg:text-5xl font-extrabold text-[var(--text-primary)] tracking-tight">Kebijakan Privasi</h1>
              <p className="mt-3 text-lg text-[var(--text-secondary)] max-w-prose">Penjelasan bagaimana data dikumpulkan, diproses, dan dilindungi dalam aplikasi Manajemen Barang. Kami berkomitmen menjaga kerahasiaan dan keamanan informasi pengguna.</p>
            </header>

            <div className="p-8 prose prose-lg max-w-none text-[var(--text-secondary)]">
              <section id="data">
                <h2 className="text-2xl font-semibold text-[var(--text-primary)]">Data yang Kami Kumpulkan</h2>
                <p className="lead">Jenis data yang kami kumpulkan mencakup data akun, data inventaris, dan data penggunaan.</p>
                <h3 className="text-xl font-medium text-[var(--text-primary)]">Contoh Data</h3>
                <ul>
              ...
              <section id="penggunaan">
                <h2 className="text-2xl font-semibold text-[var(--text-primary)]">Tujuan Penggunaan Data</h2>
                <p className="lead">Data digunakan untuk menjalankan layanan, otentikasi, dan meningkatkan pengalaman pengguna.</p>
                <h3 className="text-xl font-medium text-[var(--text-primary)]">Ruang Lingkup</h3>
                <ul>
              ...
              <section id="cookies">
                <h2 className="text-2xl font-semibold text-[var(--text-primary)]">Cookies & Tracking</h2>
              ...
              <section id="keamanan">
                <h2 className="text-2xl font-semibold text-[var(--text-primary)]">Keamanan Data</h2>
                ...
                <h3 className="text-xl font-medium text-[var(--text-primary)]">Batasan</h3>
                <p>Meskipun kami berusaha melindungi data, tidak ada sistem yang sepenuhnya bebas risiko.</p>
              </section>

              <section id="pihak-ketiga">
                <h2 className="text-2xl font-semibold text-[var(--text-primary)]">Pihak Ketiga</h2>
