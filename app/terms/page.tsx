            ...
            <div className="bg-white rounded-2xl shadow px-6 py-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Ketentuan penggunaan layanan Manajemen Barang.</p>
                </div>
              </div>
        ...
        <article className="lg:col-span-8">
          <div className="bg-white rounded-2xl shadow divide-y divide-gray-100 overflow-hidden">
            <header className="p-8">
              <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight">Syarat & Ketentuan Penggunaan</h1>
              <p className="mt-3 text-lg text-gray-600 max-w-prose">Halaman ini memuat ketentuan yang mengatur penggunaan aplikasi Manajemen Barang — mencakup pembuatan loker, pengelolaan inventaris, serta fitur pemindaian QR. Bacalah dengan seksama sebelum menggunakan layanan.</p>
            </header>

            <div className="p-8 prose prose-lg max-w-none text-gray-700">
              <section id="layanan">
                <h2 className="text-2xl font-semibold text-gray-900">Layanan</h2>
                ...
                <h3 className="text-xl font-medium text-gray-800">Ruang Lingkup Layanan</h3>
                <ul>
              ...
              <section id="akun">
                <h2 className="text-2xl font-semibold text-gray-900">Pendaftaran & Akun</h2>
                <p className="lead">Beberapa fitur memerlukan akun untuk keamanan dan personalisasi. Jagalah kerahasiaan kredensial Anda.</p>
                <h3 className="text-xl font-medium text-gray-800">Keamanan Akun</h3>
                <ul>
              ...
              <section id="kewajiban">
                ...
                <h3 className="text-xl font-medium text-gray-800">Larangan</h3>
                <ul>
              ...
              <section id="konten">
                <h2 className="text-2xl font-semibold text-gray-900">Konten & Data</h2>
                ...
                <h3 className="text-xl font-medium text-gray-800">Tanggung Jawab atas Data</h3>
                <p>Pastikan data yang Anda unggah valid dan tidak melanggar hukum atau kebijakan pihak ketiga.</p>
              </section>

              <section id="privasi">
                <h2 className="text-2xl font-semibold text-gray-900">Privasi</h2>
              ...
              <section id="pembatasan">
                <h2 className="text-2xl font-semibold text-gray-900">Pembatasan & Larangan</h2>
              ...
              <section id="pengakhiran">
                <h2 className="text-2xl font-semibold text-gray-900">Pengakhiran</h2>
                <p className="lead">Kami dapat menangguhkan atau menutup akun yang melanggar kebijakan.</p>
              </section>

              <section id="perubahan">
                <h2 className="text-2xl font-semibold text-gray-900">Perubahan Syarat</h2>
